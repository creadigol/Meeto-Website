 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'HR Tracker');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'HR Tracker');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Employee Work History');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by HR Tracker\nwww.drivehere_hrtracker.com");

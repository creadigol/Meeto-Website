	  ...
	  ?>
		   <div class="col-md-4 col-sm-6 col-xs-12">
				...
				<div class="top-margin-20"></div>	
					...
					<div class="overlay-text">
					<span class="opan-b"><?php  echo $city12['jp_name']; //$marutra = explode('"',translate(str_replace(" ","+",$seminar['name']))); echo $marutra[1]; ?></span>
					</div>
				<div class="bottom-margin-10"></div>
				</a>
			</div>
                ...
                <div class="row">
                    <div class="slider-wrapper"><!-- style="transform: translateX(219px);"-->
                    	<div class="dis_flex">
                                ...
                                ?>
                            <div class="center-slide col-xs-12 col-sm-6 col-md-3" data-index="<?php echo $i; ?>"><!--slide -->

	...
	if(mysql_num_rows($checkemail) > 0)	
	  ...
	  {			
		...
		else
		{
			...
			echo "insert into user_company (uid,name,description,timezoneid) values ($_SESSION[id],'$companyname','$companydesc','$timezone')";
	    ...
	    <div class="row">
	        ...
	        <div class="col-md-3">				
	           <div class="top-margin-20">
				...
				<a class="blue-button" href="view-profile.php?id=<?php echo $_SESSION['id']; ?>">View Profile</a>	
				</span>					

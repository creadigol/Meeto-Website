	...
	<div class="container">
		...
		<form action="" method="post" name="addseminar">
			...
			<div class="list-type" id="nav">
				...
				</ul><a href="#" class="validation" id="typevalidation">Please Select Seminar Type</a>
			</div>
				...
				<ul class="type_field_btn">
					<li class="field_btn">
						<a>
							...
							<input name="seats" onkeyup="showcontinue(this.value);" required pattern="[0-9]{1,}" type="text" placeholder="Total Seats" class="input-medium input-Accommodates">
						</a>
					</li>
				</ul>
			</div>
			...
			<div class="list-type">
				<div class="top-margin-20">&nbsp;</div>	
						<a class="blue-button" id="continue" style="pointer-events: none;" onclick="checkvalid();">Continue</a>
							...
							<div class="row price-border price-margin Location-row">
								...
								<div class="col-md-9">
									...
									<div class="overview_title">									
										...
										<input name="hostname" type="text"  placeholder="Host Person Name" class="overview-input">
									...
									<div class="overview_title">									
										...
										<input name="contactemail" type="email" placeholder="Contact Email" class="overview-input">
									...
									<div class="overview_title">									
										...
										<input name="contactno" type="text" placeholder="Contact No" class="overview-input">
							...
							<div class="row price-border price-margin Location-row">
								...
								<div class="col-md-9">
									...
									<div class="overview_title">									
										...
										<input type="date" min="<?php echo $dt; ?>" id="semifromdate" name="fromdate" placeholder="From Date" class="overview-input">
										<label class="overview-label">To Date</label>

										<input type="date" min="<?php echo $dt; ?>" id="semitodate" name="todate" placeholder="To Date" class="overview-input">
									...
									<div class="overview_title">									
										...
										<input type="text" pattern="[0-9]{1,2}[:]{1,1}[0-9]{2,2}[ ]{0,1}[ap]{1,1}[m]{1}[ ]{0,}" title="Ex : 11:00 am or 11:00 pm " name="fromtime" placeholder="From Time" class="overview-input">
										<label class="overview-label">To Time</label>

										<input type="text" pattern="[0-9]{1,2}[:]{1,1}[0-9]{2,2}[ ]{0,1}[ap]{1,1}[m]{1}[ ]{0,}" title="Ex : 11:00 am or 11:00 pm " name="totime" placeholder="To Time" class="overview-input">
							...
							<div class="row price-border price-margin Location-row">
								...
								<div class="col-md-9">
									...
									<div class="overview_title">									
										...
										<input type="text" name="tagline" placeholder="Tagline" class="overview-input">
									...
									<div class="overview_title">									
										...
										<select name="qualification" class="overview-input">

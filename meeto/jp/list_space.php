		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> 
				<div class="row">
					...
					<ul class="tab nav left_side left-menu left_back">
						<span>Settings</span>
					  <li class="tablinks" onclick="openCity(event, 'Amenities')"><span>
ファシリティ</span>
							...
							<div class="row price-border price-margin Location-row">
								...
								<div class="col-md-9">
									<div class="overview_title">									
										...
										<input name="hostname" type="text" id="hostname" placeholder="
人のホスト名" class="overview-input" required >
									</div>
									...
									<div class="overview_title">									
										...
										<input name="contactno" type="text" id="contactno" placeholder="
連絡先番号" class="overview-input" required >
									</div>
								</div>
									<div class="clearfix"></div>
							</div>
...
タイトル</label>
										<input type="text" required name="title" value="" id="title" placeholder="
タイトル" class="overview-input">

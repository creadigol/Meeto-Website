...
{	
$inbooking=mysql_query("insert into seminar_booking (seminar_id,uid,booking_no,book_seat,from_date,to_date,approval_status,created_date,modified_date,message) values ($_REQUEST[id],$_SESSION['enmeetou'][id],'$_REQUEST[bookingno]','$_REQUEST[totalseats]','$_REQUEST[fromdate]','$_REQUEST[todate]','pending','$micro','$micro','$_REQUEST[message]')");	
...
$row = mysql_fetch_array(mysql_query("select * from user where id = '".$_SESSION['enmeetou']['id']."'")); 
$rowuserdetail= mysql_fetch_array(mysql_query("select * from user_detail where uid = '".$_SESSION['enmeetou']['id']."'")); 
$rowusercompany=mysql_fetch_array(mysql_query("select * from user_company where uid = '".$_SESSION['enmeetou']['id']."'")); 

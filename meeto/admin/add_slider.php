...
<div class="upperdivche" id='hidenewfac' style='width:100%;height:149%;background: rgba(0,0,0,0.5);padding: 2%;position: fixed;z-index: 999;'>
			 ...
			 <div class="row">
                    <div class="col-md-12 page-header">
						...
						<div class="col-md-5 col-md-offset-7 btn btn-primary" onclick="facilityshow();">
							 Add New Slider <i class="fa fa-plus" style="font-size:10px;"></i>
						</div>
						</div>
                    </div>
                </div> 
									...
									?>
										...
										<td ><center><img src="../img/<? echo $data['name'];?>"style="width:150px;height:100px;transform:rotate(<?php echo $data['totateval']; ?>deg)" class="img-responsive" /></center></td>
                                           <? if($data['status']=='1'){
											?>
                                            <td><center>
												<font color="green" size="5" style="font-weight:bold;margin-top:30px;">Active</font>
												</center></td>
												<td><center>
												<font color="green" size="5" style="font-weight:bold;margin-top:30px;">Active</font>
												</center></td>
    ...
    <script src="assets/js/dataTables/dataTables.bootstrap.js"></script>
        <script>
		 ...
		 alert(degree);
	$("#id_upsempicimgplace").animate({  transform: degree },{
    step: function(now,fx) {
        $(this).css({
            '-webkit-transform':'rotate('+now+'deg)', '-moz-transform':'rotate('+now+'deg)', 'transform':'rotate('+now+'deg)'});
    }
    });
	 }*/

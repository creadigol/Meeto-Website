					...
					<div class="col-md-12"> 
						<form method="post" role="form">
							 <div class="form-group">
                                            <label>Title</label>
                                            <input class="form-control" type="text" name="addnewfac" required="" placeholder="Add New Industry" pattern="[a-zA-Z]+">
                                        </div>
										<div class="col-lg-12">
											<center>
			 ...
			 <div class="row">
                    <div class="col-md-12 page-header">
						...
						<div class="col-md-4 col-md-offset-8 btn btn-primary" onclick="facilityshow();">
							 Add New Industry <i class="fa fa-plus" style="font-size:10px;"></i>
						</div>
						</div>
                    </div>
                </div> 

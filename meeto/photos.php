	  ...
	  <div class="container">		
	    <div class="row">
		  ...
		  ?>			
				...
				<a class="blue-button button-a" href="view-profile.php?id=<?php echo $usphoid; ?>">View Profile</a>	
				</span>			
				...
				<div class="col-md-12 Required-head">	
				   <h5>Photos</h5>	  
						...
						<div class="col-md-8 photo-right">
							<div class="top-margin-20"></div>
							<p>
								Clear frontal face photos are important for hosts and renters to know each other. Landscape does not allow to know each other and undermines you Reliability Please upload a photo that clearly shows your face.
							</p>

...
<?php
	...
	if($seminar_detail['approval_status']=="rejected" || $seminar_detail['status']=="0")
	{
		$err=1;
	}
			...
			<br><br><br><br><br><br><br><br><br><br><br><br>
				<div class="col-md-5 col-md-offset-4" style="border:1px solid #333; background:#fff">
					...
					<div class="col-md-12" id="deleteusermsg" style="padding:20px;"> 
						<h4 style="color:red;font-weight:bolder;">Your Seminar Rejected By Admin OR Expire Seminar...</h4>

 <?php   
  ...
  $locarray=array();
   $data = mysql_query("select *,p.image as image from seminar,seminar_photos as p where cityid=$_REQUEST[id] and approval_status='approved' and status='1' and seminar.id=p.seminar_id group by seminar.id");
   //echo "select *,p.image as image from seminar,seminar_photos as p where cityid=$_REQUEST[id] and approval_status='approved' and seminar.id=p.seminar_id group by seminar.id";
		...
		<div class="filter_bar_div">
        	<div class="container">
            	<div class="col-xs-12 col-sm-5 col-md-5">
                	<div class="filt">
                    	<h5 style="margin-bottom:15px;"><center>Dates</center></h5>
                ...
                <div class="col-xs-12 col-sm-7 col-md-7 seminar-Attendees-box">
                	<div class="filt">
                    	<h5><center>Seminar Attendees</center></h5>
				...
				<div class="col-xs-12 col-sm-10 col-md-10">
                	<div class="filt">
                    	<h5><center>Industry Type</center></h5>
                        <div class="group-control">
                        	<div class="Seminar-Attendees industry-type">
							 ...
							 <span class="check"><?php echo $industrydetail['name'];?></span>
							  </label> 
				        	<?php
					        }
					       ?>
				...
				<div class="col-xs-12 col-sm-2 col-md-2 seminar-Attendees-box">
                	<div class="filt">
                    	<h5><center>Seminar Place</center></h5>
                        <div class="group-control">
                        	<div class="Seminar-Attendees seminar-place">
							 ...
							 <span class="check"><?php echo $semitypedetail['name'];?></span>
							  </label> 
				        	<?php
					        }
					       ?>

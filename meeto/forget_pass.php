	   ...
	   {  
        $fetchemail=mysql_fetch_array($checkemail);
	     if($email==$fetchemail['email']) 
		 {
            ...
            echo "<script>alert('For new password  sent mail Please check  your mail and reset your password!');</script>";    
			...
			<form method="post" action="" enctype="multipart/form-data">				
				...
				<div class="col-md-12 Required-head">	
				   ...
				   <ul class="nav">							
					...
					<li class="li-input">			
					<label class="users">Enter Your Email :</label>		
					<input type="email" class="input-name" name="useremail" id="" required value=""></br>
					<li class="li-input">
					  <div class="col-md-8 col-md-offset-4">
					   <button type="submit" name="submit_butto" class="blue-button save border-n">Submit</button>
					  </div>
					</li>
					<div class="top-margin-20">&nbsp;</div>
					</ul>
